...
<div align="center">
    <h1> <!-- !!! change version !!! -->
        Zabbix Server version check template
    </h1>
    <h4>
        This template allows you to check curent Zabbix server version and triggers whether the version is up to date or not. <!-- !!! change version !!! -->
    </h4>
    <br>
    <img src="./.readme/screen/template_Zabbix_Server_Version01.png" width="1000"> <!-- !!! change version !!! -->
</div>
<br>
<br>
...
## Setup
1\. Download and import [template](/Zabbix_Server_version/template_Zabbix_Server_Version.yaml)

2\. Assign on your Zabbix server host
