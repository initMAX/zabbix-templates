...
<div align="center">
    <h1> <!-- !!! change version !!! -->
        Zabbix Template - Cisco QoS monitoring
    </h1>
    <h4>
        This template allows you to monitor QOS traffic on Cisco switches. <!-- !!! change version !!! -->
    </h4>
    <!--<br>
...
This template allows you to monitor QOS traffic on Cisco switches.

## Requirements
 - Zabbix 6.4 or higher

## Setup
1\. Download and import [template](/Cisco_QoS_Monitoring/Template_Cisco_QoS.yaml)

2\. Assign on your Cisco host
