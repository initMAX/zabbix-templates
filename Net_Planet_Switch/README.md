...
<div align="center">
    <h1> <!-- !!! change version !!! -->
        Zabbix Template - Planet Switches
    </h1>
    <h4>
        Template for Planet switch monitoring <!-- !!! change version !!! -->
    </h4>
    <!-- <br>
...
Template for Planet switch monitoring

### Uses private Enterprise MIB:
| Model               | MIB OID                |
|:-------------------:|:----------------------:|
| SGS-5240-48T4X      | 1.3.6.1.4.1.10456.1    |
| XGS-5240-24X2QR     | 1.3.6.1.4.1.10456.100  |

## Requirements
 - Zabbix 6.0 or higher

## Setup
1\. Download and import template
  - [Planet_SGS-5240-48T4X](/Net_Planet_Switch/Planet_SGS-5240-48T4X_by_SNMP.yaml)
  - [Planet_XGS-5240-24X2QR](/Net_Planet_Switch/Planet_XGS-5240-24X2QR_by_SNMP.yaml)

2\. Assign to your monitored hosts
