...
<div align="center">
    <h1> <!-- !!! change version !!! -->
        TCP/UDP socket monitoring template
    </h1>
    <br>
    <img src="./.readme/screen/template_TCP_UDP_sockets01.png" width="1000"> <!-- !!! change version !!! -->
</div>
<br>
<br>
...
This template create items for standard TCP/UDP sockets checks.
...
1\. Download and import template (valid for the version)
  - [6.0](/TCP_UDP_Sockets/6.0/template_TCP_UDP_sockets.yaml)
  - [7.0](/TCP_UDP_Sockets/7.0/template_TCP_UDP_sockets.yaml)
