...
<div align="center">
    ...
    <h4>
        This template allows you to check the current OpenFiles settings for Zabbix server processes. <!-- !!! change version !!! -->
    </h4>
</div>
<br>
<br>
...
## Setup
1\. Download and import [template](/Open_Files/template_Zabbix_Server_OpenFiles_Settings.yaml)
